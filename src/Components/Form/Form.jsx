            ...
            <Form onSubmit={handleSubmit}>
              <div className="flex items-center justify-center border-b  pb-2">
                ...
                <Field
                  ...
                  id="name"
                  name="name"
                  className="block bg-white w-full px-2 py-1 border-0 focus:outline-none focus:ring-0"
                  value={values.name}
              ...
              <button
                className="w-full mt-2 py-2 px-4 bg-blue-500 text-white font-semibold rounded-md shadow hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50"
                type="submit"
              >
                Submit
              </button>
